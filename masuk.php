        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Tambah Stok BBM</h1>
                    <br>
                    <h2></h2>
                    <div class="card mb-4">
                                ...
                                <table class="table table-bordered table-hover" id="" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_GET['tglawal'])) {
                                            ...
                                            $ambilsemuadatastok = mysqli_query($conn, "select * from masuk m, stok_bbm s where s.idbbm = m.idmasuk and tanggal between '$tglawal' and DATE_ADD('$tglakhir',INTERVAL 1 DAY) order by idmasuk desc");
                                        } elseif (isset($_GET['cari'])) {
                                            $cari = $_GET['cari'];
                                            $ambilsemuadatastok = mysqli_query($conn, "select * from masuk m, stok_bbm s where s.idbbm = m.idbbm and (m.keterangan like '%" . $cari . "%' or  m.jumlah like '%" . $cari . "%' or m.tanggal like '%" . $cari . "%')");
                                        } else {
                                            $ambilsemuadatastok = mysqli_query($conn, "select * from masuk m, stok_bbm s where s.idbbm = m.idbbm");
                                        }
                                                            ...
                                                            <form method="POST">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="input-group mb-2">
                                                                        ...
                                                                        <input type="text" class="form-control" name="" value="<?= $jk; ?>" readonly>
                                                                    </div>
                                                                    <div class="input-group mb-2">
                                                                        <span class="input-group-text" style="width: 135px;">
                                                                            <center>Tahun Anggaran</center>
                                                                        </span>
                                                                    ...
                                                                    <div class="input-group mb-2">
                                                                        ...
                                                                        <input type="num" class="form-control" name="jumlah" value="<?= $jml; ?>" required>
                                                                    </div>
                                                                    <center>
                                                ...
                                                <div class="modal fade" id="hapus<?= $idm ?>">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="POST">
                                                                <div class="modal-body">
                                                                    Apakah Anda yakin ingin menghapus data "<?= $keterangan; ?>" untuk kendaraan berjenis <?= $jk ?> dengan jumlah <?= $jml; ?> liter?
                                                                    <input type="hidden" name="idbbm" value="<?= $idb ?>">
                                                                    <input type="hidden" name="idmasuk" value="<?= $idm ?>">
            ...
            <form method="POST">
                <div class="modal-body">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" class="form-control" name="jumlah" placeholder="Liter" required>
                    </div>
                    <center>
