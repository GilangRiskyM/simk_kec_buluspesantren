                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="col mt-2 ml-2">
                                ...
                                <form action="surat_tugas2" method="get" class="form-inline">
                                    <div class="mb-2">
                                        <input type="text" name="cari" class="form-control ml-2" required>
                                        <button type="submit" class="btn btn-info">Cari</button>
                                        <a href="surat_tugas2" class="btn btn-danger">Batal</a>
                                    </div>
                                </form>
                                <hr>
                                <label class="mb-2">Filter Data</label>
                                <form method="get" action="surat_tugas2" class="form-inline">
                                    ...
                                    <a href="surat_tugas2" class="btn btn-danger ml-2">Batal</a>
                                </form>
                            </div>
                        </div>
                        <div class="card-body">
