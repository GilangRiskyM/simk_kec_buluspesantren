...
$query = "select * from cetak order by tanggal asc";
...
if (isset($_GET["export"])) {
    if (empty($_GET["tglawal"])) {
        ...
        $orderQuery = "select * from cetak where tanggal >= '" . $_GET["tglawal"] . "' AND tanggal <= '" . $_GET["tglakhir"] . "' order by id ASC";
        ...
        if (count($filterOrders)) {
            ...
            $filename = "Laporan " . $tglawal . " Sampai " . $tglakhir . ".xls";
